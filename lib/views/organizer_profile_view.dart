...
import '../viewmodels/organizer_profile_viewmodel.dart';
...
class OrganizerProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => OrganizerProfileViewModel(),
      child: const _OrganizerProfileBody(),
    );
  }
}

class _OrganizerProfileBody extends StatelessWidget {
  const _OrganizerProfileBody();

  @override
  Widget build(BuildContext context) {
    final vm = context.watch<OrganizerProfileViewModel>();
    // User data with fallback
    final displayName = vm.user?.name ?? 'Loading...';
    final role = 'Event Organizer';
